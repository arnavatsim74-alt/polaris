        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg text-sm">
              ...
              <p><strong>Heard About LATV:</strong> {selectedApp?.hear_about_aflv || "N/A"}</p>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="col-span-2">
                <p className="text-muted-foreground">Where did you hear about LATV?</p>
                <p className="font-medium">{selectedApp?.hear_about_aflv || "N/A"}</p>
              </div>
            </div>
            <div>
              <p className="text-muted-foreground text-sm mb-1">Why they want to join LATV</p>
